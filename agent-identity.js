...
// - **File Name:** `agent-identity.js` (inside your `nexus-core` repo).
// - **The Blueprint:** Define a single operative using exactly five different primitive types.
//     1. `agentName`: (String)
//     2. `agentID`: (Number) - *Make this unique.*
//     3. `isShiftActive`: (Boolean)
//     4. `shiftPerformance`: (Null) - *Intentional absence of data until they actually work.*
//     5. `nextReviewDate`: (Undefined) - *Let the engine leave this uninitialized.*
